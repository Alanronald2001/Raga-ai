    ...
    svg: (
      <svg viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M8 1a7 7 0 100 14A7 7 0 008 1zm-.75
    ...
    svg: (
      <svg viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M6.457 1.047c.659-1.234 2.427-1.234 3.086
    ...
    svg: (
      <svg viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M8 1a7 7 0 100 14A7 7 0 008 1zm3.78
    ...
    <li>
      <button
        ...
        className={clsx(
          ...
          n.read ? 'bg-white hover:bg-slate-50' : clsx(config.bg, 'hover:brightness-95')
        )}
      >
        {/* Type icon */}
        <span
        ...
        {/* Unread dot */}
        {!n.read && <span className={clsx('mt-1.5 h-2 w-2 shrink-0 rounded-full', config.dot)} />}
      </button>
    </li>
  )
}
